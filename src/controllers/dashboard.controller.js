...
// Si el usuario autenticado es docente, solo se consideran sus propios eventos
// y las asistencias asociadas a ellos.
exports.getDashboardOverview = async (req, res) => {
  try {
    ...
    // Filtro base para eventos; restringe por creador cuando el rol es docente
    const eventFilter = req.user.rol === 'docente' ? { creadorId: req.user.id } : {};
    let asistenciaMatch = {};
    if (req.user.rol === 'docente') {
      // Obtener IDs de los eventos del docente para limitar las asistencias
